...
block.innerHTML += `<h3>Чем отличаются программисты от разработчиков?</h3>
<p>Умением переходить из группы в группу.</p>`;
...
/* *
    document.getElementsByName("usr");
* */
